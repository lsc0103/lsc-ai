...
export const SEL = {
  ...
  workbench: {
    ...
    container: '[data-testid="workbench-container"]',
    header: '[data-testid="workbench-header"]',
    closeBtn: '[data-testid="workbench-close-btn"]',
    content: '[data-testid="workbench-content"]',
    tabs: '[data-testid="workbench-tabs"]',
    tab: '[data-testid="workbench-tab"]',
    tabClose: '[data-testid="workbench-tab-close"]',
    layout: '[data-testid="workbench-layout"]',
    resizer: '[data-testid="workbench-resizer"]',
    area: '[data-testid="workbench-area"]',
    codeEditor: '.workbench-code-editor, .monaco-editor, [class*="CodeEditor"]',
    dataTable: 'table, .ant-table, [class*="DataTable"]',
    contextMenu: '.ant-dropdown-menu, .ant-dropdown, [role="menu"]',
  },
